...
# Load data from csv
def load_data(filepath='datos_energia.csv'):
...
def description_card():
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                id="intro",
                children="Esta herramienta contiene información sobre la demanda energÃ©tica total en Austria cada hora según lo publicado en ENTSO-E Data Portal. Adicionalmente, permite realizar pronósticos hasta 5 dias en el futuro."
            ),
        ],
    )
